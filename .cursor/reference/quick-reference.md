...
- ✅ Quick lookups during coding ("What's the commit format?")
- ✅ Team onboarding (read this first, then dive into detailed workflows)
- ✅ Printed reference card (post on wall, keep at desk)
- ✅ Fast answers to common questions

**Don't use this for:**
- ❌ Following complete workflows (use detailed workflow files instead)
- ❌ Understanding WHY (use full workflows for context and examples)
- ❌ Comprehensive implementation guidance

**Think of it as:** A cheat sheet, not a replacement for the full playbook.
